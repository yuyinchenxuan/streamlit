...
tab1, tab2, tab3, tab4= st.tabs(["Outline", "Training", "Optimization", "Performance Evaluation"])
# ===================== Outline =====================
with tab1:
    st.markdown("""
    - Trained default linear and non-linear regression models, then picked 4 models for hyperparameter tuning
...
with tab2:
    ...
    # ===================== Non-Linear Models ================
    elif section == "Non-Linear Models":
