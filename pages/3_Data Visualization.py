...
with desc2:
    ...
    **Attendance Time**  
    ...
    - Predefined threshold of 1200 seconds could be applied where attendance times are unavailable.
...
with desc3:
    ...
    **Correlation with Target**  
    ...
    - Significance (desceding order): DelayCodeId, Distance, PumpOrder, NumStationsWithPumpsAttending, PumpCount
